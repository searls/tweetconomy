...
The demo application runs on Heroku so all you have to do is tell Heroku about your specific configuration.  Assuming you have pushed your application to Heroku, run the following:
